...
export async function POST(request: Request) {
  ...
  return proxyAdminRequest("/admin/games/greedy/availability", session, { method: "POST", headers: forwardMutationHeaders(request), body: JSON.stringify(await readJson(request)) });
}
