...
export async function GET() {
  ...
  return proxyAdminRequest("/admin/games/greedy-classic/config-versions", session);
}
...
export async function POST(request: Request) {
  ...
  return proxyAdminRequest("/admin/games/greedy-classic/config-versions", session, { method: "POST", headers: forwardMutationHeaders(request), body: JSON.stringify(body) });
}
