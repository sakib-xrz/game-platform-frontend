...
export async function POST(request: Request) {
  ...
  return proxyAdminRequest("/admin/games/greedy-classic/cancel-current-round", session, { method: "POST", headers: forwardMutationHeaders(request), body: JSON.stringify(body) });
}
